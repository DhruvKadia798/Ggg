    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        ...
        <div class="jumbotron bg-white">
          ...
          <h5>Service : 299 , Washing : 999 and Complain : 299</h5>
    ...
    <div class="card-deck mb-3 text-center">
      <div class="card mb-4 shadow-sm">
        <div class="card-header">
          <h6 class="my-0 font-weight-bold text-secondary"><font class="text-danger">30% Off</font> One Time Service</h6>
        </div>
        <div class="card-body">
          <h3 class="card-title pricing-card-title"><span id="onetime">299</span><small>/&#8360. </small> <small class="text-muted"><del>499 /&#8360.</del></small> </h3>
          <ul class="list-unstyled mt-3 mb-4">
            <li><h6> No of AC : <span id="acs">1</span> </h6></li>
            <li><h5 class="text-success"> No Complain Free</h5></li>
            <li><h5 class=" text-primary"> Service : 1</h5></li>
          ...
          <form action="one-package-booking">
            ...
            <button type="button" class="btn btn-lg btn-block btn-outline-primary">Get Service</button>
         </form>
      ...
      <div class="card mb-4 shadow-lg">
        <div class="card-header">
          <h6 class="my-0 font-weight-bold text-secondary"><font class="text-danger">50% Off</font> One Year Service Plan</h6>
        </div>
        <div class="card-body">
          <h3 class="card-title pricing-card-title"><span id="oneyear">999</span><small>/&#8360.</small> <small class="text-muted"><del>1999 /&#8360.</del></small> </h3>
          <ul class="list-unstyled mt-3 mb-4">
            <li><h6> No of AC : <span id="acs1">1</span> </h6></li>
            <li><h5 class="text-success"> One Complain Free</h5></li>
            <li><h5 class=" text-primary"> Service : 4</h5></li>
      ...
      <div class="card mb-4 shadow-sm">
        <div class="card-header">
          <h6 class="my-0 font-weight-bold text-secondary"><font class="text-danger">53.5% Off</font> Two Year Service Plan</h6>
        </div>
        <div class="card-body">
          <h3 class="card-title pricing-card-title"><span id="twoyear">1999</span><small>/&#8360</small> <small class="text-muted"><del>3999 /&#8360.</del></small> </h3>
          <ul class="list-unstyled mt-3 mb-4">
            <li><h6> No of AC : <span id="acs2">1</span> </h6></li>
            <li><h5 class="text-success"> Two Complain Free</h5></li>
            <li><h5 class=" text-primary"> Service : 8 </h5></li>
            <li><h6> Gape : 4 month</h6></li>
